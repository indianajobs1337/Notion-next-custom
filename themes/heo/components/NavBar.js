...
const NavBar = props => {
  ...
  return (
    <>
      ...
      <nav
        id="nav"
        className={`${fixedNav ? 'fixed' : 'relative bg-none'} ${
          textWhite ? 'text-white ' : 'text-black dark:text-white'
        }  ${
          navBgWhite ? 'bg-white dark:bg-[#18171d]' : 'bg-none'
        } z-20 h-16 top-0 w-full`}
      >
        <div className="flex h-full mx-auto justify-between items-center max-w-[86rem] px-8">
          ...
          {/* 右侧固定 */}
          <div className="flex flex-initial justify-center items-center space-x-1">
