...
function Banner(props) {
  ...
  function handleClickBanner() {
    // Путь к статье по клику на баннер
    router.push('article/80cc4605-cab4-404d-8fd5-24230f2491ee')
  }
...
function TopGroup(props) {
  // Recommended посты берутся из массива объектов latestPosts
  // latestPosts в свою очередь получают функцией getLatestPosts
      ...
      >
        ...
        >
          ...
          <div
            ...
            } cursor-pointer flex items-center px-3 h-10 justify-center bg-[#425aef] hover:bg-[#4259efcb] transition-colors duration-100 rounded-3xl`}
          >
            <PlusSmall
        ...
        <div
          ...
          className={`${
            isCoverUp ? '' : ' pointer-events-none'
          }  today-card-cover absolute w-full h-full top-0`}
          style={{
            background:
