...
const BLOG = {
  ...
  KEYWORDS:
    ...
    'overemployed, hr, human resources, dataspace, encrypted', // 网站关键词 英文逗号隔开

  // СОЦ.СЕТИ
  CONTACT_EMAIL: 'hello@x-ray.me', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: 'https://twitter.com/51netsec', // 你的twitter个人主页
  CONTACT_LINKEDIN: 'https://www.linkedin.com/jobs', // 你的linkedIn 首页
  CONTACT_BILIBILI: '', // B站主页
  CONTACT_YOUTUBE: 'https://www.youtube.com/@indiana_jobs', // Youtube主页
  // СОЦ.СЕТИ
